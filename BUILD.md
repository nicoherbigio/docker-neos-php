# Building instructions for the Neos PHP Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/neos-php:8.3-bullseye 8.3/debian/apache/default/
```
...
docker push nicoherbigde/neos-php:8.3-bullseye
```
